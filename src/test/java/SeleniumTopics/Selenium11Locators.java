...
public class Selenium11Locators {
    @Test(groups = "QA")
...
//        5. Verify that the error message is shown "Your email, password, IP address or location did not match"
        ...
        // Project #2 - TC    (POSITIVE)   Find the Email id and enter the email as admin@admin.com
        ...
        driver.quit();
        // Stop the session and edge browser which is opened.
